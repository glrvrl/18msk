...
export default function Anlayis() {
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Eğitim Anlayışımız - Sirac Koleji</title>
      ...
      <body>
              ...
              <div className="collapse navbar-collapse" id="siracNavbar">
                <ul className="navbar-nav ms-auto">
                  ...
                  <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle active" href="#" data-bs-toggle="dropdown">Kurumsal</a>
                    <ul className="dropdown-menu">
                      <li><a className="dropdown-item active" href="/anlayis">Eğitim Anlayışımız</a></li>
        ...
        <section className="education-header">
          <div className="container">
            <h1 className="display-4 fw-bold">Eğitim Anlayışımız</h1>
            <p className="lead">Montessori Destekli Değer Yaklaşımı ile Geleceğin Liderlerini Yetiştiriyoruz</p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-8 mx-auto">
                <div className="education-principles">
                  <h2 className="text-center mb-5">Eğitim Felsefemiz</h2>

                  <p className="lead text-center mb-5">
                    Her insanın neyi, nasıl, en iyi şekilde öğreneceğini ancak rehberlerinin liderliğiyle kendisinin belirleyebileceğini esas alan Montessori Destekli Değer Yaklaşımının ilkeleri ile bireyler; İslami kültür doğrultusunda tasarlanmış eğitim ortamlarında özgür iradelerini kullanarak fıtratlarını şekillendirirler.
                  </p>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="principle-card">
                        ...
                        <p>Her çocuğun öğrenme şekli ve zeka türü farklıdır. Bu nedenle kurumumuzda çoklu zeka kuramı doğrultusunda eğitim verilmekte ve bu doğrultuda her bir çocuk için en yüksek başarı hedeflenmektedir.</p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="principle-card">
                        ...
                        <h4>Değerler Eğitimi</h4>
                        <p>Başarıya değer katan, geçmişini unutmayan, güvenilir ve ahlaklı nesiller yetiştirecek eğitim anlayışı ile hareket edilmektedir.</p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="principle-card">
                        ...
                        <h4>Kültürel Köprü</h4>
                        <p>Bu bakış açısı; ecdadı ile torunları arasında sağlam bir köprü kurarak, vicdanın ziyasi ve akün nuru ile hakikate ulaştıran bir akademik eğitim anlayışını benimsemektedir.</p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="principle-card">
                        ...
                        <p>Öğrencilerimizin bireysel yeteneklerini keşfetmelerine ve potansiyellerini en üst düzeyde gerçekleştirmelerine olanak sağlayan bir eğitim modeli uyguluyoruz.</p>
                      </div>
                    </div>
                  </div>
                </div>

                <div className="montessori-section text-center">
                  <h3 className="mb-4">Montessori Destekli Eğitim Modeli</h3>
                  <p className="mb-4">Montessori eğitim felsefesini İslami değerlerle harmanlayarak, çocuklarımızın hem dünyevi hem de uhrevi gelişimlerini destekliyoruz. Özgür seçim, öz disiplin ve kendini yönetme becerilerini geliştiren bu yaklaşım, öğrencilerimizin yaşam boyu öğrenen bireyler olmalarını sağlıyor.</p>
                  <a href="/kozmik" className="btn btn-light">Montessori Atölyelerimizi Keşfedin</a>
                </div>

                <div className="quote-section">
                  <p>"Eğitim, çocuğa bilgi yüklemek değil, onun içindeki cevheri işleyerek ortaya çıkarmaktır."</p>
                  <p className="text-end fw-bold">- Maria Montessori</p>
                </div>

                <div className="text-center mt-5">
                  <a href="/iletisim" className="btn btn-primary btn-lg me-3">Bize Ulaşın</a>
                  <a href="/galeri" className="btn btn-outline-primary btn-lg">Eğitim Ortamlarımızı Görün</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer>
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-2 col-md-6 mb-4 mb-md-0">
                ...
                <ul className="footer-links list-unstyled">
                  ...
                  <li><a href="/anlayis">Eğitim Anlayışımız</a></li>
            ...
            <div className="copyright">
              ...
              <p className="mt-2"><small>www.18martsirackoleji.k12.tr</small></p>
            </div>
          </div>
        </footer>
